...
public partial class EfcnorthwindContext : DbContext
{
    public EfcnorthwindContext()
    {
        this.ChangeTracker.LazyLoadingEnabled = false;
    }

    public EfcnorthwindContext(DbContextOptions<EfcnorthwindContext> options)
        : base(options)
    {
    }

    public EfcnorthwindContext(bool lazyLoadingEnabled)
    {
        this.ChangeTracker.LazyLoadingEnabled = lazyLoadingEnabled;
    }
    ...
    {
        var useVers2 = bool.Parse(Config.ConfigItems["UseV2"]);
        var connStr1 = Config.ConfigItems.GetConnectionString("EFCNorthwind");
        var connStr2 = Config.ConfigItems.GetConnectionString("EFCNorthwindVers2");
        optionsBuilder.UseLazyLoadingProxies();
        optionsBuilder.UseSqlServer(useVers2 ? connStr2 : connStr1);
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CategorySalesFor1997>(entity =>
        {
            ...
            entity.Property(e => e.CategoryName).HasMaxLength(15);
            entity.Property(e => e.CategorySales).HasColumnType("decimal")
                            .HasPrecision(18, 4);
        });
        ...
        modelBuilder.Entity<ProductSalesFor1997>(entity =>
        {
            ...
            entity.Property(e => e.CategoryName).HasMaxLength(15);
            entity.Property(e => e.ProductName).HasMaxLength(40);
            entity.Property(e => e.ProductSales).HasColumnType("decimal")
                            .HasPrecision(18, 4);
        });
        ...
        modelBuilder.Entity<SalesTotalsByAmount>(entity =>
        {
            ...
            entity.Property(e => e.CompanyName).HasMaxLength(40);
            entity.Property(e => e.OrderId).HasColumnName("OrderID");
            entity.Property(e => e.SaleAmount).HasColumnType("decimal")
                            .HasPrecision(18, 4);
            entity.Property(e => e.ShippedDate).HasColumnType("datetime");
        });
